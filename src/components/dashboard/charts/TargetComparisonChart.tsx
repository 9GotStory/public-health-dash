...
type Datum = { name: string; avg: number; threshold: number };
...
export const TargetComparisonChart = ({ data, maxBars = 5 }: { data: Datum[]; maxBars?: number }) => {
    ...
    <div className="w-full h-72">
      <ResponsiveContainer>
        <ComposedChart data={enriched} margin={{ left: 8, right: 8, top: 8, bottom: 8 }}>
          ...
          <XAxis dataKey="name" tick={{ fontSize: 12 }} interval={0} height={50} angle={0} />
